...
namespace AzurePushNotificationDemoSender
{
    /// <summary>
    /// Using code from https://github.com/Azure/azure-notificationhubs-samples/tree/master/PushToWNSDirectly and http://msdn.microsoft.com/en-us/library/windows/apps/xaml/hh868252.aspx 
    /// Put here just to complete this sample project.
    /// </summary>
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string xml = @"<toast><visual><binding template=""ToastText01""><text id=""1"">Hello, World</text></binding></visual></toast>";
            string notificationType = "wns/toast";
            string contentType = "text/xml";

            // The channel URI you got from WNS for your client app https://db3.notify.windows.com/?token=xxxxxxxxxxxxxxxxxx
            Console.WriteLine("Paste the channelUri and hit enter:");
            string channelUri = Console.ReadLine();
